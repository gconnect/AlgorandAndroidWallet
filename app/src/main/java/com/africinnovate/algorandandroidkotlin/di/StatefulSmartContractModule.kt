...
import com.africinnovate.algorandandroidkotlin.repositoryImpl.StatefulContractRepositoryImpl
...
@Module
abstract class StatefulSmartContractModule {
        @Singleton
        @Binds
        abstract fun bindCourse(impl: StatefulContractRepositoryImpl): StatefulContractRepository
}